...
export const RATING_SEX_ITEMS: SelectItemWithDesc<string>[] = [
...
export const RATING_VIOLENCE_ITEMS: SelectItemWithDesc<string>[] = [
...
export const REGION_ITEMS: SelectItem<string>[] = [
