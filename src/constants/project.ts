...
export const RATING_VIOLENCE_ITEMS: SelectItemWithDesc<RatingViolence>[] = [
    ...
    {label: "C", value: "c", color: "orange", desc: ["存在较重的暴力、凶杀、其他不当行为", "较重的血腥内容、重度暴力倾向、凶杀和残杀、猎奇和惊悚恐吓内容"]},
    {label: "D", value: "d", color: "red", desc: ["存在严重引起生理或心理不适，严重影响三观的内容", "重度的血腥、暴力和凶杀，强烈的猎奇内容，容易留下心理阴影的内容"]}
]
