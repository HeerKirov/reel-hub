...
export default async function MovieRecordDetail({ params }: { params: Promise<{ id: string }> }) {
    const { id } = await params
    ...
    return <RecordDisplay type={ProjectType.MOVIE} project={project} record={data} />
}
