...
export default async function NovelRecordDetail({ params }: { params: Promise<{ id: string }> }) {
    const { id } = await params
    ...
    return <RecordDisplay type={ProjectType.NOVEL} project={project} record={data} />
}
