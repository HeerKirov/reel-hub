...
export default async function NovelCommentDetail({ params }: { params: Promise<{ id: string }> }) {
    const { id } = await params
    ...
    return <CommentDisplay type={ProjectType.NOVEL} project={project} comment={data} />
}
