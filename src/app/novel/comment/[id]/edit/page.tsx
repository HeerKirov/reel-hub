...
export default async function NovelCommentEdit({ params }: { params: Promise<{ id: string }> }) {
    const { id } = await params
    ...
    return <CommentEditor type={ProjectType.NOVEL} project={project} comment={data} />
}
